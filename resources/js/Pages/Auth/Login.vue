        ...
        <form @submit.prevent="submit" class="w-sm">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3 mb-10">
                    <InputField label="Email" type="email" placeholder="Email" v-model="form.email" :error="form.errors.email" />
                </div>
                <div class="w-full px-3 mb-10">
                    <InputField label="Password" type="password" v-model="form.password" :error="form.errors.password" />
