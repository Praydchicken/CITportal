...
const filteredStudents = computed(() => {
    return props.students.filter(student => {
        const schoolYearMatch = !selectedSchoolYear.value || student.school_year_id === selectedSchoolYear.value;
...
//     router.get(route('teacher.student.grades', { student: student.id }));
// };
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-[#1a3047]">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Student Number</th>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Year Level</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Section</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">First Semester</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Second Semester</th>
                        </tr>
                    </thead>
