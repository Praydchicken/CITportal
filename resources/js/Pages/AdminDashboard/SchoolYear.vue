            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-lg shadow p-6 mb-6">
                    <form @submit.prevent="submitForm" class="flex gap-4 items-end">
                        <div class="flex-1">
                            <label for="school_year" class="block text-sm font-medium text-gray-700 mb-1">School
                                Year</label>
                            <input type="text" id="school_year" v-model="form.school_year"
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="(year, index) in schoolYears" :key="year.id"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <button v-if="year.school_year_status !== 'Active'"
